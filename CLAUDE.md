...
**Design:** Clean, Apple-inspiriert, eigenständig (keine Lizenzprobleme)
...
- Keine Garmin-eigenen Watch-Face-Designs nachbauen (Regel seit Mai 2025)
...
- Java JDK 17, VS Code + Monkey C Extension, Connect IQ SDK 7.x+
- Linux: `connect-iq-sdk-manager-cli` für SDK-Management
...
- Garmin nimmt 15% Provision (vs. 30% Apple/Google)
